...
function NavBar({ userEmail, changeView, handleLogout, welcomeText }) {
  ...
  return (
    <div>
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <button className="ml-3" onClick={() => handleClick("Add")}>
                {" "}
                Ajout de visiteur
              </button>
            </li>
            <li className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <button className="ml-3" onClick={() => handleClick("Evenement")}>
                {" "}
                Evenement
              </button>
      ...
      {/* ... d'autres boutons pour les autres composants */}
    </div>
  );
}
